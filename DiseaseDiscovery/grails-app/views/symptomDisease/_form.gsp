...
<div class="fieldcontain ${hasErrors(bean: symptomDiseaseInstance, field: 'disease', 'error')} required">
	...
	<g:select id="disease" name="disease.id" from="${diseaseDiscovery.domain.com.Disease.list()}" optionKey="id" required="" value="${symptomDiseaseInstance?.disease?.id}" class="many-to-one"/>
</div>
...
<div class="fieldcontain ${hasErrors(bean: symptomDiseaseInstance, field: 'symptom', 'error')} required">
	...
	<g:select id="symptom" name="symptom.id" from="${diseaseDiscovery.domain.com.Symptom.list()}" optionKey="id" required="" value="${symptomDiseaseInstance?.symptom?.id}" class="many-to-one"/>
</div>
