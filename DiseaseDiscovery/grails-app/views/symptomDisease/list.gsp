...
<html>
	...
	<body>
		<a href="#list-symptomDisease" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="list-symptomDisease" class="content scaffold-list" role="main">
			...
			<div class="pagination">
				<g:paginate total="${symptomDiseaseInstanceTotal}" />
			</div>
		</div>
	</body>
</html>
